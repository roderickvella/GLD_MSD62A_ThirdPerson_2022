...
public class Explosion : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach(Collider collider in colliders)
        {
            ...
            //!rigidbodies.Contains(collider.attachedRigidbody -> we are making sure that the same rigidbody is not added more than
            //once in the list rigidbodies (in case the object has multiple colliders)
